...
import "../../Style/TeachNumber.css"; // Adjust the path if needed
...
const Number6 = () => {
  ...
  const handleNextClick = () => {
    navigate("/teaching_number7"); // Navigate to teaching_number7 component
  };

  const handlePracticeClick = () => {
    navigate("/practice_number6"); // Navigate to /practice_number6 for practice
  };
      ...
      <div className="number-container">
        ...
        <div
          ...
          style={{
            ...
            backgroundColor: "yellow", // yellow color for the first three touchpoints
          }}
        ></div>
        <div
