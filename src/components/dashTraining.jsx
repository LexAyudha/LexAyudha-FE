    ...
    <div className='flex h-[calc(100%-20px)] flex-col'>
      <div className='flex w-full'>
        <div className='flex w-[50%] flex-col'>
          ...
          <p><span className='font-bold'>Date: </span>{res.data.training.session.date ? res.data.training.session.date : 'N/A'}</p>
          <p><span className='font-bold'>Time: </span>{res.data.training.session.time ? res.data.training.session.time : 'N/A'}</p>
          <p><span className='font-bold'>Status: </span>{res.data.training.session.status ? res.data.training.session.status : 'N/A'}</p>
          <p><span className='font-bold'>Session ID: </span>{res.data.training.session.Id ? res.data.training.session.Id : 'N/A'}</p>
          ...
          <div className='w-[65%] flex justify-center items-center '>
            <div className='flex flex-col w-full'>
              ...
              <div className='flex items-center justify-center flex-col'>
                <img className=' w-[100px] h-fit object-cover' src={trophies[0].icon} alt={trophies[0].name} />
