...
export default function Dashboard() {
  ...
  const user = {
    ...
    proPic:
      "https://icon-library.com/images/famous_character_-_add_on_1-27-512.png",
    coverPic: "https://xansan.com/wp-content/uploads/2018/10/default-cover.gif",
  };

  const fallbacks = {
    proPic:
      "https://ik.imagekit.io/75mgj6y0wrj/https://flickchartavatars.blob.core.windows.net/web/97cb634b-efa1-47cc-b511-10edc1b73f5a.png",
    coverPic:
      "https://greenwipes.com.my/wp-content/uploads/2021/06/Hero-Banner-Placeholder-Light-2500x1172-1-1536x720.png",
  };
    ...
    <div className="la-container flex">
            ...
            <div className="relative w-fit ">
              <div className="w-[150px] h-[150px] rounded-full shadow-[0px_0px_5px_1px_rgba(0,_0,_0,_0.1)] overflow-hidden">
                <i
                  ...
                  onClick={handleProPicEdit}
                ></i>
                <Image
                  src={userData.proPic ? userData.proPic : fallbacks.proPic}
                  alt="profile picture"
                />
              </div>
            </div>
      ...
      <div className=" w-full relative bg-gray-200 flex flex-col items-center justify-center">
        <div className="w-full h-[320px] z-[0] group relative">
          <img
            src={userData.coverPic ? userData.coverPic : fallbacks.coverPic}
